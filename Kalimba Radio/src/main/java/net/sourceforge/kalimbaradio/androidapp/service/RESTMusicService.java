 ...
 */
package net.sourceforge.kalimbaradio.androidapp.service;
...
import net.sourceforge.kalimbaradio.androidapp.domain.Lyrics;
import net.sourceforge.kalimbaradio.androidapp.domain.SearchCritera;
import net.sourceforge.kalimbaradio.androidapp.domain.ServerInfo;
import net.sourceforge.kalimbaradio.androidapp.service.parser.PlaylistParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.SearchResultParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.ShareParser;
import net.sourceforge.kalimbaradio.androidapp.util.Constants;
import net.sourceforge.kalimbaradio.androidapp.util.FileUtil;
import net.sourceforge.kalimbaradio.androidapp.R;
import net.sourceforge.kalimbaradio.androidapp.domain.Indexes;
import net.sourceforge.kalimbaradio.androidapp.domain.JukeboxStatus;
import net.sourceforge.kalimbaradio.androidapp.domain.MusicDirectory;
import net.sourceforge.kalimbaradio.androidapp.domain.MusicFolder;
import net.sourceforge.kalimbaradio.androidapp.domain.Playlist;
import net.sourceforge.kalimbaradio.androidapp.domain.SearchResult;
import net.sourceforge.kalimbaradio.androidapp.domain.Version;
import net.sourceforge.kalimbaradio.androidapp.service.parser.AlbumListParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.ErrorParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.IndexesParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.JukeboxStatusParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.LicenseParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.LyricsParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.MusicDirectoryParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.MusicFoldersParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.PlaylistsParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.RandomSongsParser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.SearchResult2Parser;
import net.sourceforge.kalimbaradio.androidapp.service.parser.VersionParser;
import net.sourceforge.kalimbaradio.androidapp.service.ssl.SSLSocketFactory;
import net.sourceforge.kalimbaradio.androidapp.service.ssl.TrustSelfSignedStrategy;
import net.sourceforge.kalimbaradio.androidapp.util.CancellableTask;
import net.sourceforge.kalimbaradio.androidapp.util.Logger;
import net.sourceforge.kalimbaradio.androidapp.util.ProgressListener;
import net.sourceforge.kalimbaradio.androidapp.util.ServerSettingsManager;
...
public class RESTMusicService implements MusicService {
    ...
    public Version getLocalVersion(Context context) throws Exception {
        PackageInfo packageInfo = context.getPackageManager().getPackageInfo("net.sourceforge.kalimbaradio.androidapp", 0);
