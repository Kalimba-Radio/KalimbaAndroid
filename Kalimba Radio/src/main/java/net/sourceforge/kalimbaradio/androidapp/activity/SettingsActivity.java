...
import net.sourceforge.kalimbaradio.androidapp.util.ErrorDialog;
...
import net.sourceforge.kalimbaradio.androidapp.util.ModalBackgroundTask;
...
public class SettingsActivity extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setHideMedia(prefs.getBoolean(Constants.PREFERENCES_KEY_HIDE_MEDIA, true));
