...
/**
 * @author Sindre Mehus
 * @version $Id: Constants.java 4022 2014-05-13 19:46:02Z sindre_mehus $
 */
...
//check
   ...
   /* public static final String PREFERENCES_KEY_SERVER_ADDRESS = "http://www.kalimbaradio.com:4040";
    public static final String PREFERENCES_KEY_SERVER_ADMIN_UNAME = "admin";
    public static final String PREFERENCES_KEY_SERVER_ADMIN_PASSWORD = "H@rd2Cr@ck";*/
    public static final String PREFERENCES_KEY_SERVER_ADDRESS = "http://www.kalimbaradio.com:4040";
    //public static final String PREFERENCES_KEY_SERVER_ADDRESS = "http://130.211.128.142:4040";
    public static final String PREFERENCES_KEY_SERVER_ADMIN_UNAME = "admin";
    public static final String PREFERENCES_KEY_SERVER_ADMIN_PASSWORD = "H@rd2Cr@ck";
    public static final String PREFERENCES_KEY_SERVER_USER_PASSWORD = "XXXXXXX";
    public static final String PREFERENCES_REST_SERVER_ADDRESS = "http://www.kalimbaradio.com";
    //public static final String PREFERENCES_REST_SERVER_ADDRESS = "http://130.211.128.142";
    // Name of the preferences file.
    public static final String PREFERENCES_FILE_NAME = "net.sourceforge.kalimbaradio.androidapp_preferences";
