 ...
 */
package net.sourceforge.kalimbaradio.androidapp.provider;
...
public class SubsonicAppWidgetProvider extends AppWidgetProvider {
    ...
    /**
     * Handle a change notification coming over from {@link net.sourceforge.kalimbaradio.androidapp.service.DownloadService}
     */
     ...
     *                     widget click will launch {@link net.sourceforge.kalimbaradio.androidapp.activity.DownloadActivity},
     *                     otherwise we launch {@link net.sourceforge.kalimbaradio.androidapp.activity.MainActivity}.
     */
