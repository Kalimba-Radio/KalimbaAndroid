...
import net.sourceforge.kalimbaradio.androidapp.receiver.MediaButtonIntentReceiver;
...
public class AudioManagerHelper {
    ...
    private static final String EVENT_META_CHANGED = "net.sourceforge.kalimbaradio.androidapp.EVENT_META_CHANGED";
    private static final String EVENT_PLAYSTATE_CHANGED = "net.sourceforge.kalimbaradio.androidapp.EVENT_PLAYSTATE_CHANGED";
